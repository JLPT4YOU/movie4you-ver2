      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="text-red-500">Chính sách bảo mật</li>
          </ol>
        </nav>
        ...
        <header className="mb-10 text-center">
          <div className="flex items-center justify-center mb-3">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-red-600 to-red-400 bg-clip-text text-transparent">
              Chính Sách Bảo Mật (Quốc tế)
            </h1>
          </div>
          <p className="text-gray-400">Ngày hiệu lực: 18/08/2025</p>
          <p className="text-gray-400">Dịch vụ: MOVIE4YOU (movie4you.net) — Dịch vụ miễn phí</p>
          <p className="text-gray-400">
            Liên hệ: <a href="mailto:movie4you.owner@gmail.com" className="text-red-400 hover:text-red-300">movie4you.owner@gmail.com</a>
          </p>
        </header>
        ...
        <section className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 mb-6">
          <h2 className="text-2xl font-semibold text-white mb-3 flex items-center">
            <span className="text-red-500 mr-3">🧭</span> 1. Mục đích & Phạm vi áp dụng
          </h2>
        ...
        <section className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 mb-6">
          <h2 className="text-2xl font-semibold text-white mb-3 flex items-center">
            <span className="text-red-500 mr-3">📌</span> 2. Tóm tắt nhanh
          </h2>
        ...
        <section className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 mb-6">
          <h2 className="text-2xl font-semibold text-white mb-3 flex items-center">
            <span className="text-red-500 mr-3">🧾</span> 3. Danh mục dữ liệu & mục đích xử lý
          </h2>
          <div className="space-y-4">
            <div className="border-l-4 border-red-500 pl-4">
              <h3 className="font-semibold text-white mb-1">Log kỹ thuật</h3>
              <p className="text-sm">IP, user-agent, loại thiết bị, thời gian, URL đã truy cập — phục vụ vận hành, bảo mật, chống lạm dụng.</p>
        ...
        <section className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 mb-6">
          <h2 className="text-2xl font-semibold text-white mb-3 flex items-center">
            <span className="text-red-500 mr-3">🍪</span> 4. Cookie & Công nghệ tương tự
          </h2>
        ...
        <section className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 mb-6">
          <h2 className="text-2xl font-semibold text-white mb-3 flex items-center">
            <span className="text-red-500 mr-3">🤝</span> 6. Chia sẻ dữ liệu với bên thứ ba
          </h2>
        ...
        <section className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
          <h2 className="text-2xl font-semibold text-white mb-3 flex items-center">
            <span className="text-red-500 mr-3">🛡️</span> 8. Bảo mật thông tin
          </h2>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
        ...
        <section className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 mb-6">
          ...
          <p>
            Dịch vụ không hướng tới trẻ em dưới 13 tuổi. Nếu bạn là phụ huynh/người giám hộ và tin rằng trẻ em
        ...
        <section className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 mb-6">
          <h2 className="text-2xl font-semibold text-white mb-3 flex items-center">
            <span className="text-red-500 mr-3">🛠️</span> 16. Thay đổi Chính sách
          </h2>
          <p>
